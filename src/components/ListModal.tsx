...
import { ArrowDownIcon, ArrowLeftIcon, BnbIcon, CalendarIcon, CloseCircleIcon, EthIcon, VerifiedIcon } from "./SvgIcons"
            ...
            <div className="w-full h-full flex justify-center items-center overflow-auto">
                ...
                >
                    ...
                    <div className="modal_body text-center">
                        ...
                        {makeList && (
                            <LoadingPad title="Processing" description="Confirm the transaction in your wallet to list your NFT" />
                        )}
                        <button className="w-full rounded-lg bg-white text-[16px] font-semibold py-3 mt-6" onClick={handleList}>List Item</button>
                    </div>
                </div>
            </div>
        </div>
