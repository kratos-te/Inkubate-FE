    ...
    >
      ...
      <div className="modal_body text-center flex-col space-y-8">
        <div className="flex justify-between border-2 border-white rounded-full my-14">
          <div
            className={`flex space-x-2 justify-center border-white py-2 w-1/2 rounded-full items-center cursor-pointer ${
              isEther ? "bg-white text-black" : "bg-black text-white"
            }`}
          ...
          <div
            className={`flex space-x-2 justify-center w-1/2 border-white py-2 px-4 rounded-full items-center cursor-pointer ${
              isBnb ? "bg-white text-black" : "bg-black text-white"
            }`}
        ...
        <div className="flex-col">
          ...
          <div className="flex-col mt-2 relative">
            ...
            <div className="flex justify-between p-2 rounded-xl bg-[#333333] mt-2">
              ...
              <div className="flex space-x-2 rounded-full px-4 py-2 bg-[#373C41] items-center my-auto">
                <EthIcon
                  className="bg-blue-500 rounded-full pt-1"
                  color="blue"
                />
            ...
            <div
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black rounded-full p-2 w-10 h-10"
              onClick={handleSwap}
            >
              <SwapIcon />
            </div>
        ...
        {isConvert && (
          <div className="flex space-x-4">
            <button type="button" className="" disabled>
              <svg
                className="animate-spin h-20 w-20 mr-3  text-gray-200  dark:text-[#041B2D] fill-[#EA4492]"
                viewBox="0 0 100 101"
                fill="none"
        ...
        <div
          className="flex justify-center py-3 bg-white text-black text-[16px] rounded-2xl cursor-pointer"
