                    ...
                    <div className="modal_body text-center">
                        ...
                        <div className="flex-col gap-6 py-7 border-b-[1px] border-[#666666]">
                            ...
                            <div className="flex justify-between mt-6">
                                <p className=" text-[16px] text-[#B3B3B3] font-normal">Creator Royalty</p>
                                <p className=" text-[16px] text-[#B3B3B3] font-normal"> 2.5%</p>
                            </div>
                        </div>
                        <div className="flex justify-between py-[28px]">
                            <p className="text-[20px] font-semibold text-left text-white">Total Earnings </p>
                            <div className="flex-col">
                                <p className="text-[24px] font-semibold text-right  text-secondary">0.05 ETH</p>
                                <p className="text-[16px] font-semibold text-right text-[#666666]">($100.00)</p>
                            </div>
                        </div>
                        <button className="w-full rounded-[12px] bg-white text-[16px] font-semibold py-3 mb-7 mt-9">Accept</button>
                    </div>
                </ClickAwayComponent>
            </div>
        </div>
